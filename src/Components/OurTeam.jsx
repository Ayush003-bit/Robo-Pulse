...
export function Team() {
  ...
  return (
    <div className="bg-gray-100 py-16 px-4">
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 items-stretch">
        {Team.map((item) => (
          <div key={item.id} className="h-full">
            <div className="bg-white rounded-2xl p-8 text-center shadow-md border border-gray-100 transition-all duration-300 hover:shadow-2xl hover:-translate-y-2 group flex flex-col h-full">
              ...
              {/* This makes content stretch evenly */}
              <p className="text-gray-500 text-sm pt-2 flex-grow">
                {item.msg}
              </p>
